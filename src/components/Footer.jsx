    ...
    <footer className="bg-[#080808] text-slate-500 pt-32 pb-16 relative overflow-hidden">
      ...
      <div className="container">
        <motion.div 
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-16 lg:gap-20 mb-20 md:mb-32"
        >
          {/* Brand Concept */}
          <motion.div variants={itemVars} className="md:col-span-2 lg:col-span-5">
            <div className="flex items-center gap-4 md:gap-6 mb-6 md:mb-10">
              ...
              <div>
                <h3 className="text-slate-900 text-lg md:text-2xl font-light tracking-[0.2em] uppercase">Madhuban</h3>
                <span className="text-[9px] md:text-[10px] font-bold text-primary tracking-[0.4em] uppercase">Sanstha Pune</span>
              </div>
            </div>
            ...
            <div className="flex gap-6 md:gap-8">
              {[Facebook, Instagram, Youtube].map((Icon, i) => (
                <motion.a 
                  ...
                  className="p-2 md:p-3 rounded-full border border-white/5 hover:border-primary/30 transition-all duration-500"
                >
          ...
          <motion.div variants={itemVars} className="md:col-span-1 lg:col-span-3">
             <h4 className="text-slate-900 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.4em] mb-6 md:mb-12 opacity-80">Discovery</h4>
          ...
          <motion.div variants={itemVars} className="md:col-span-2 lg:col-span-4">
             <div className="glass p-6 md:p-8 lg:p-10 rounded-2xl lg:rounded-3xl border-white/5 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-24 md:w-32 h-24 md:h-32 bg-primary/20 blur-3xl group-hover:bg-primary/40 transition-all duration-700"></div>
                <h4 className="text-slate-900 text-lg md:text-xl font-light mb-4 md:mb-6 relative z-10">Ready to <span className="italic text-primary">Collaborate?</span></h4>
                ...
                <Link to="/contact" className="btn bg-white text-black w-full hover:bg-slate-200 text-[9px] md:text-[10px] tracking-widest relative z-10 transition-all duration-500">
                   Support the Mission
                </Link>
             </div>
          </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="flex flex-col md:flex-row justify-between items-start md:items-center pt-8 md:pt-12 border-t border-white/5 text-[8px] md:text-[10px] font-bold tracking-[0.3em] md:tracking-[0.4em] uppercase gap-4"
        >
