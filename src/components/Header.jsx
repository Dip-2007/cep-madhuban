...
import { Menu, X, Heart, Languages, Moon, Sun, ArrowRight } from 'lucide-react';
...
const Header = () => {
  ...
  return (
    <>
      ...
      {/* ── Mobile Slide-In Menu (Full Screen Panel from Right) ── */}
      <AnimatePresence>
        {isOpen && (
          <>
            {/* Backdrop overlay */}
            ...
            >
              ...
              <div className="mobile-menu-header">
                <div className="flex items-center gap-3">
                  ...
                  />
                  <span className="text-primary font-bold text-lg tracking-widest">
                    {t('nav.madhuban')}
                  </span>
                </div>
                <button 
                  ...
                  return (
                    <motion.div key={link.name} variants={linkItemVariants}>
                      ...
                      >
                        ...
                        <ArrowRight size={16} className="mobile-menu-link-arrow" />
                      </Link>
                    </motion.div>
                  );
                })}
              ...
              >
                <Link 
                  to="/donate" 
                  onClick={() => setIsOpen(false)} 
                  className="mobile-menu-donate-btn"
                >
                  <Heart size={16} />
                  {t('nav.support')}
                </Link>
