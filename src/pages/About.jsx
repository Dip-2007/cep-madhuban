          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-24 items-start mb-40 min-w-[1024px]">
            ...
            >
              <div className="relative group">
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-premium">
                  <img 
                    ...
                    className="w-full h-auto md:h-auto min-h-[400px] lg:min-h-[600px] object-cover hover:scale-105 transition-transform duration-1000" 
                  />
                </div>
              </div>
              ...
              <div className="mt-8 bg-white p-8 md:p-10 shadow-premium rounded-2xl border-l-[6px] border-primary relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
                ...
                <h4 className="text-3xl sm:text-4xl font-light text-slate-900 mb-2 leading-tight tracking-tight break-words">{t('about.narrative.founderName')}</h4>
                <p className="text-primary/70 text-sm font-medium italic tracking-wide break-words">{t('about.narrative.founderRole')}</p>
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-sm sm:text-base md:text-lg text-muted leading-relaxed font-light break-words">
                  {t('about.narrative.missionP1')}
                </p>
                <p className="text-sm sm:text-base text-muted leading-relaxed font-light break-words">
                  {t('about.narrative.missionP2')}
                </p>
              </div>

              <div className="mt-12 space-y-6">
                <h3 className="text-2xl sm:text-3xl font-light text-primary italic break-words">{t('about.narrative.featuresTitle')}</h3>
                <ul className="space-y-3 sm:space-y-4 text-sm sm:text-base text-muted leading-relaxed font-light list-disc pl-5 break-words">
